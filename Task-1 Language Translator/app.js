...
function speakText(text, langCode) {
  ...
  // Use online Google TTS as primary since it supports all OS setups (no local voice pack required)
  if (navigator.onLine) {
    console.log("Online: Using Google Translate TTS API...");
    speakViaGoogleTTS(text, langCode);
  } else {
    console.log("Offline: Falling back to native SpeechSynthesis...");
